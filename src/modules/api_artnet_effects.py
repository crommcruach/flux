...
def register_artnet_effects_api(app, player_manager):
    ...
    def get_artnet_effects():
        ...
        try:
            ...
            # If using dedicated artnet_player, use video chain (its default)
            # If using main player, use artnet chain
    ...
    def update_artnet_effect_parameter(index):
        ...
        try:
            ...
            # Get effect from appropriate chain
            chain = player.video_effect_chain if player == player_manager.get_artnet_player() else player.artnet_effect_chain
