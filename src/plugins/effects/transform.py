...
class TransformEffect(PluginBase):
    ...
    def initialize(self, config):
        ...
        self.position_x = config.get('position_x', 0.0)
        self.position_y = config.get('position_y', 0.0)
        self.scale_xy = config.get('scale_xy', 100.0)
        self.scale_x = config.get('scale_x', 100.0)
        self.scale_y = config.get('scale_y', 100.0)
        self.rotation_x = config.get('rotation_x', 0.0)
        self.rotation_y = config.get('rotation_y', 0.0)
        self.rotation_z = config.get('rotation_z', 0.0)
        self.anchor_x = config.get('anchor_x', 50.0)
        self.anchor_y = config.get('anchor_y', 50.0)
