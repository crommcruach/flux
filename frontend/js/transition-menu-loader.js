/**
 * Transition Menu Component Loader
 * Loads the transition menu component HTML and injects it into the page
 */

(async function() {
    try {
        // Fetch the component HTML
        const response = await fetch('/static/components/transition-menu.html');
